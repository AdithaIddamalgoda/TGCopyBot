...
# dst_new_chat = getenv("NEW_DESTINATION") or None
...
# def copy_message_new(from_chat_id: int, message_id: int, send_copy: bool = True) -> None:
#     data = {
#         'chat_id': dst_new_chat,
#         'from_chat_id': from_chat_id,
#         'message_ids': [message_id],
#         'send_copy': send_copy,
#     }
...
# def new_message_handler_second_chat(update):
#     # To print every update:
#     # print(update)
...
if __name__ == "__main__":
    ...
    # if (src_chat is None or dst_new_chat is None):
    #     print("\nPlease enter SOURCE and NEW_DESTINATION in .env file")
    #     exit(1)
    # else:
    #     src_chat = int(src_chat)
    #     dst_new_chat = int(dst_new_chat)

    tg.add_message_handler(new_message_handler)
    # tg.add_message_handler(new_message_handler_second_chat)
